...
// Content for "How to Build a Content Strategy That Ranks"
const contentStrategyContent = [
  ...
  block('The keyword golden ratio helps identify quick win opportunities. Find keywords with search volume between 250 and 1000 monthly searches, fewer than 50 pages with the keyword in the title, commercial or informational intent matching your business, and low domain authority in current top 10 results.'),
...
export default defineMigration({
  title: 'Populate comprehensive content for all posts',
  documentTypes: ['blogPost'],

  migrate: {
    document(doc, context) {
      // Update specific blog posts by title
      if (doc.title === 'How to Build a Content Strategy That Ranks' && (!doc.content || doc.content.length === 0)) {
        return at('content', set(contentStrategyContent))
      }
